...
@Component
@Service
public class AssetPreviewActivateProcess implements WorkflowProcess {
	@Property(value = "Collect the Asset References of a page and activate them to Preview Instance")
	static final String DESCRIPTION = Constants.SERVICE_DESCRIPTION;
	@Property(value = "Adobe")
	static final String VENDOR = Constants.SERVICE_VENDOR;
	@Property(value = "Asset Preview Publish")
			...
			if (workflowData.getPayloadType().equals(TYPE_JCR_PATH)) {
				...
				for (Map.Entry<String, Asset> assetMap : assetReference
					...
					try {
						 ...
						 */
						activateAssetToPreview(jcrSession, asset, activate);
	...
	private void activateAssetToPreview(Session jcrSession, Asset asset,
