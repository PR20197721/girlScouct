...
CQ.form.DateTime = CQ.Ext.extend(CQ.Ext.form.Field, {
    ...
    initComponent:function() {
		...
		/* var timeZoneConfig = CQ.Ext.apply({}, {
			...
			width: this.readOnly ? this.timeZoneWidth - this.defaultTriggerWidth : this.timeZoneWidth,
            hideTrigger: this.readOnly,
            minListWidth: this.timeZoneWidth,
            selectOnFocus:this.selectOnFocus,
            allowBlank:this.allowBlank,
            readOnly: this.readOnly,
            xtype:"Selection",                               
        ...
        alert("timeZone" +timeZoneConfig);
        this.tz = new CQ.Ext.form.TextField(timeZoneConfig);
        delete(this.timeZoneFormat);
*/

		var timeZoneConfig = new CQ.form.Selection({
            type:"select",
            cls:"customwidget-1",
            listeners: {
                selectionchanged: {
        ...
        this.relayEvents(this.tz, ['focus', 'specialkey', 'invalid', 'valid']);
    ...
    onRender:function(ct, position) {
        ...
        if('below' === this.timePosition || 'bellow' === this.timePosition) {
            t = CQ.Ext.DomHelper.append(ct, {tag:'table',style:'border-collapse:collapse',children:[
                 ...
                 {tag:'tr',children:[{tag:'td', style: this.hideTime ? "display:none;" : "", cls:"ux-datetime-timezone"}]}
            ]}, true);
        } else {
            t = CQ.Ext.DomHelper.append(ct, {tag:'table',style:'border-collapse:collapse',children:[
                {tag:'tr',children:[
                    ...
                    {tag:'td', style: this.hideTime ? "display:none;" : "", cls:"ux-datetime-timezone"}
                ]}
            ]}, true);
        }
        ...
        this.tz.render(t.child('td.ux-datetime-timezone'));
        ...
        this.tz.el.swallowEvent(['keydown', 'keypress']);
        ...
        if('side' === this.msgTarget) {
            ...
            this.tz.errorIcon = this.errorIcon;
        }
     ...
     */
    isValid:function() {
        return this.df.isValid() && this.tf.isValid() && this.tz.isValid();
    },
    /**
    ...
    setSize:function(w, h) {
        ...
        if('below' === this.timePosition) {
            ...
            if(CQ.Ext.isIE) {
                ...
                this.tz.el.up('td').setWidth(this.timeZoneWidth);
            }
        }
...
// register xtype
CQ.Ext.reg("gsdatetime", CQ.form.DateTime);
