...
<% 
  ...
  %>
  <div>
            <img src="<%=properties.get("fileReference", String.class)%>" width="50" height="50"/>
            <h2><a href="<%=properties.get("urltolink")%>.html"><%=properties.get("featuretitle",String.class) %></a></h2>
  </div>
