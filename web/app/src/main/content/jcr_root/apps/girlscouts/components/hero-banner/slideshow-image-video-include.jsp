			...
			<% 
				if (link[i].indexOf("https://www.youtube.com") != -1) {%>
					<div class="videoWrapper">
						<iframe id="youtubePlayer<%=i%>" src="<%=link[i]%>" width="100%" height="100%" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
					</div>
			<% } else if (link[i].indexOf("https://player.vimeo.com/video/") != -1) {%>
					<div class="videoWrapper">
						<iframe id="vimeoPlayer<%=i%>" src="<%=link[i]%>" width="100%" height="100%" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
					</div>
			<% } else {%>
