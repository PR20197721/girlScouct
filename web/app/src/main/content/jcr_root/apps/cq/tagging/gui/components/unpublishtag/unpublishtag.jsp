...
%>
<ui:includeClientLib categories="cq.tagging.touch.unpublishtag" />
<div id="<%= cfg.get("id") %>" class="coral-Modal notice <%= cfg.get("rel") %>">
    <div class="coral-Modal-header">
        <i class="coral-Modal-typeIcon coral-Icon coral-Icon--sizeS"></i>
        <h2 class="coral-Modal-title coral-Heading coral-Heading--2"><%= i18n.get("Unpublish Tag") %></h2>
    ...
    <div class="coral-Modal-body">
        <p><%= i18n.get("Are you sure to unpublish the selected tag(s)?") %></p>
    </div>
    <div class="coral-Modal-footer">
        <button type="button" class="coral-Button" data-dismiss="modal"><%= i18n.get("Cancel") %></button>
        <button type="button" class="coral-Button coral-Button--warning coral-Button--primary" data-dismiss="modal"><%= i18n.get("Unpublish") %></button>
    </div>
</div>


<%-- error dialog --%>
<div class="coral-Modal error tags-unpublish-error">
    <div class="coral-Modal-header">
    ...
    <div class="coral-Modal-body">
        <p><%= i18n.get("Failed to unpublish tag(s).") %></p>
    </div>
    <div class="coral-Modal-footer">
