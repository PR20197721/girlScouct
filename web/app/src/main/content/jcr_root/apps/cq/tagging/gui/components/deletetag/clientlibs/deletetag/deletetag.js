...
(function(document, $) {
    ...
    var rel = ".cq-tagging-touch-actions-delete";
    var delActivator = ".cq-tagging-touch-actions-deletetag-activator";
    function deleteTags(paths, force) {
        ...
        $.ajax({
            ...
            success: function() {
                ...
                new Granite.UI.NotificationSlider($(".endor-Page-content.endor-Panel").eq(0), $(".endor-BlackBar")).notify({
                    content: Granite.I18n.get("Tag(s) deleted successfully"),
                    type: "info",
    ...
    $(document).on("beforeshow" + rel, ".coral-Modal" + rel, function () {
        ...
        singleContentMessage = Granite.I18n.get("You are going to delete the following tag:");
        multipleContentMessage = Granite.I18n.get("You are going to delete the following {0} tags:", selectedItems.length);
