...
<script type="text/javascript">
    $(document).on("foundation-contentloaded", function(e) {
        $(".movetag-wizard-title").val("<%=xssAPI.encodeForHTML(title) %>");
     });

</script>

<ui:includeClientLib categories="cq.tagging.touch.movetag" />
<div id="movetagsettings" data-redirect="<%= xssAPI.getValidHref(redirectPath) %>">
     ...
     <div class="coral-FixedColumn-column">
        <section>
            <section class="coral-Form-fieldset">
                <input class="coral-Form-field coral-Textfield" type="hidden" name="cmd" value="moveTag">
                ...
                <input class="coral-Form-field coral-Textfield movetag-original-path" name="path" type="text" value="<%= xssAPI.encodeForHTMLAttr(path) %>" disabled>
                ...
                <input class="coral-Form-field coral-Textfield movetag-rename-to" type="text" id="rename" value="<%= xssAPI.encodeForHTMLAttr(name) %>" aria-required="true" data-validation="foundation.jcr.name">
            </section>
             <section class="coral-Form-fieldset">
