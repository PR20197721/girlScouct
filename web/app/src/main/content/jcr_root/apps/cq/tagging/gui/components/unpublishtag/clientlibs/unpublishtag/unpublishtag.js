...
(function(document, $) {
    ...
    var rel = ".cq-tagging-touch-actions-unpublish";
    var unpublishActivator = ".cq-tagging-touch-actions-unpublishtag-activator";
    function unpublishTags(paths, force) {
        ...
        $.ajax({
            ...
            success: function() {
                ...
                new Granite.UI.NotificationSlider($(".endor-Page-content.endor-Panel").eq(0), $(".endor-BlackBar")).notify({
                    content: Granite.I18n.get("Selected tag(s) queued up for unpublishing"),
                    type: "info",
            ...
            error: function(data) {
                $(rel).modal("hide");
                $(".tags-unpublish-error").modal("show");
            }
        });
    }
    ...
    $(document).on("beforeshow" + rel, ".coral-Modal" + rel, function () {
        ...
        singleContentMessage = Granite.I18n.get("You are going to unpublish the following tag:");
        multipleContentMessage = Granite.I18n.get("You are going to unpublish the following {0} tags:", selectedItems.length);
