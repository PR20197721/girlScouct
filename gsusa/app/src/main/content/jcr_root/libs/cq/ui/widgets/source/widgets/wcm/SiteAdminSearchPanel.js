    ...
    constructor: function(config) {
        ...
        this.actions.push({
            ...
            "tooltip": {
                ...
                "text": CQ.I18n.getMessage("Refreshs the list of results"),
                "autoHide":true
            }
        });
        ...
        var defaultColumns = [
            ...
            CQ.wcm.SiteAdminSearchPanel.COLUMNS["path"],
                        ...
                        "convert":function(v,record){
                            try {
                                if(!record["jcr:content"]["cq:name"]) {
                                    ...
                                    return CQ.shared.XSS.getXSSValue(record["jcr:content"]["cq:name"]);
                                }
                            } catch (e) {
                                return "";
                            }
