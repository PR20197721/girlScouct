...
%><%@include file="/libs/granite/ui/global.jsp" %><%
    ...
    if (workflowData!=null && PayloadMap.TYPE_JCR_PATH.equals(workflowData.getPayloadType())) {
        ...
        //Girlscouts modification to properly save dialog participant step parameters in workflow item metadata 
        try{
        	payloadPath = workitem.getWorkflow().getId()+"/data/metaData";
        }catch(Exception e){
