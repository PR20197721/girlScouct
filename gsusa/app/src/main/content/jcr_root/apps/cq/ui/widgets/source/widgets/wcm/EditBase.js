...
//            }
    ...
    switchLock: function(aDialog) {
        CQ.Ext.Msg.confirm(
            ...
            this.liveStatusLocked ? CQ.I18n.getMessage("Do you really want to cancel the inheritance?") : CQ.I18n.getMessage("Do you really want to revert the inheritance? Your changes will be lost."),
            function(btnId) {
                if (btnId == "yes") {
    ...
    /**
     *Girl Scouts - doSwitchLock modified to synchronize child component with parent on inheritance restoration.
     */
