    ...
    return {
        ...
        getAllowedApps: function() {
        	...
        	for(var i = 0; i < this.data.allowedApps.length; i++){
        		var current = this.data.allowedApps[i];
        		if(current.vanityPath == "/siteadmin"){
        			allowed[0]=current;
        		}else if(current.vanityPath == "/damadmin"){
        			allowed[1]=current;
        		}else if(current.vanityPath == "/mcmadmin"){
        			allowed[2]=current;
        		}else if(current.vanityPath == "/inbox"){
        			allowed[3]=current;
        		}else if(current.vanityPath == "/useradmin"){
        			allowed[4]=current;
        		}else if(current.vanityPath == "/miscadmin"){
        			allowed[5]=current;
        		}else if(current.vanityPath == "/tagging"){
        			allowed[6]=current;
        		}else{ //In case something new is added, it should be added to the end
        			allowed[6+i]=current;
        		}
        	}
        	var cleanArray = [];
