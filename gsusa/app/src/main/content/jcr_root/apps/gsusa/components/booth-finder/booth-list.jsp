...
<form action="<%=slingRequest.getRequestURI() %>" class="sort-form clearfix" style="margin-top: 0.7rem;">
    <section>
        ...
        <select name="radius" onchange="getUpdatedFilterResult(event)">
    ...
    <section>
        <label>Date:</label>
        <select name="date" onchange="getUpdatedFilterResult(event)">
    ...
    <section>
        <label>Sort by:</label>
        <select name="sortBy" onchange="getUpdatedFilterResult(event)">
            <!-- default -->
