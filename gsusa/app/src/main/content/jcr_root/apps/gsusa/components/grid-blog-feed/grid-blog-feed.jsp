...
$(document).ready(function() {
	...
	if (displaySampleFeed == true) {
		var result =  { items: [{
				...
				content: "This is a sample blog feed to help author style how blog feeds will appear. Once published, all the feeds will be replaced with real blog feeds."
			}, {
				url: "http://blog.girlscouts.org",
