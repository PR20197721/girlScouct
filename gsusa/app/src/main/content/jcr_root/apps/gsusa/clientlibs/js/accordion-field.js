...
girlscouts.functions.deleteaccordion=function(field, event){
	if(deleteAccordionFlag == false){
		...
		CQ.Ext.Msg.show({
			title: "Warning", 
			msg: "If you delete this field, all content contained within will be removed as well. You can RESTORE the content at a later point IN THIS ACCORDION COMPONENT ONLY by using the same identifier. " +
