			...
			if (path.indexOf("http:") != -1 || path.indexOf("https:") != -1) {
		        ...
		        if(parent){
		            if(isPlaceholder && !eyebrowNavVal){
		                ...
		                sb.append("<div class="+sideNavClass+"><a style='padding-left: 0px;' href=\"" + genLink(rr, path) + "\" title=\"" + label + "\">" + "< "+ label + "</a><span class='side-nav-expand'>></span></div><hr>");
                        ...
                        sb.append("<div class="+sideNavClass+"><a style='padding-left: 0px;' href=\"" + genLink(rr, path) + "\" title=\"" + label + "\">" + "< "+ label + "</a></div><hr>");
		            }
		        }else{
