		...
		try{
			...
			if (path.indexOf("http:") != -1 || path.indexOf("https:") != -1) {
		        if(parent && !eyebrowNavVal){
		            sb.append("<div class="+sideNavClass+"><a style='color: #FFA500;'x-cq-linkchecker=\"skip\" href=\"" + genLink(rr, path) + "\" title=\"" +label + "\" tabindex=\"-1\" "+target+">" +"< "+ label + "</a></div><hr>");
                }else{
		        ...
		        if(parent){
		            if(isPlaceholder && !eyebrowNavVal){
		                sb.append("<div class="+sideNavClass+"><span id='side-nav-active-parent' style='color: #FFA500 !important; padding-top: 17px; padding-bottom: 17px; display: inline-block; padding-left: 0px; margin-left: -9px;' title=\"" + label + "\">" + "<div class='tab-selected'>< </div>"+ label + "</span><span class='side-nav-expand'>></span></div><hr>");
		            }else if(isParent && !eyebrowNavVal){
		                sb.append("<div class="+sideNavClass+"><a style='color: #FFA500 !important; padding-left: 0px;' href=\"" + genLink(rr, path) + "\" title=\"" + label + "\">" + "<div class='tab-selected'>< </div>"+ label + "</a><span class='side-nav-expand'>></span></div><hr>");
                        ...
                        sb.append("<div class="+sideNavClass+"><a style='color: #FFA500 !important; padding-left: 0px;' href=\"" + genLink(rr, path) + "\" title=\"" + label + "\">" + "<div class='tab-selected'>< </div>"+ label + "</a></div><hr>");
		            }
		        }else{
