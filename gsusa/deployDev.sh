...
curl  -u 'admin:e$Fz&rsBS.XZk$6F'  -X POST http://52.71.87.139:4502/crx/packmgr/service/.json/etc/packages/org.girlscouts.web.gsusa/gsusa-app-$VERSION.zip?cmd=delete
...
curl  -u 'admin:e$Fz&rsBS.XZk$6F'  -X POST http://52.1.73.148:4503/crx/packmgr/service/.json/etc/packages/org.girlscouts.web.gsusa/gsusa-app-$VERSION.zip?cmd=delete
