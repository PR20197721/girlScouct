...
<%
    ...
    buildMenu(rootPage, currentPage.getPath(), sb, true);
%>
<nav class="left-nav">
    <%= sb.toString() %>
</nav>
...
<%!
    public void buildMenu(Page rootPage, String currentPath, StringBuilder sb, boolean isTopLevel) {
        ...
        while(iter.hasNext()) {
            ...
            if (hasChild == false) {
                sb.append(isTopLevel ? "<ul class=\"off-canvas-list\">" : 
            ...
            if (title != null && !title.isEmpty()) {
                ...
                String activeCls = isActive ? "has-submenu" : "";
                ...
                if (isActive) {
                    buildMenu(page, currentPath, sb, false);
                }
