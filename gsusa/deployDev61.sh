...
curl -u "ooooo" -F file=@"$HOME/.m2/repository/org/girlscouts/web/gsusa-content/$VERSION/gsusa-content-$VERSION.zip" -F name="gsusa-content" -F force=true -F install=true http://52.1.73.148:4503/crx/packmgr/service.jsp
