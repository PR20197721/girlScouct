...
import org.girlscouts.tools.meetingimporter.CollectionHoldString;
...
public class Meeting {
    ...
    @Collection
    private java.util.Map<String, CollectionHoldString> meetingInfo;

    public java.util.Map<String, CollectionHoldString> getMeetingInfo() {
        return meetingInfo;
    }

    public void setMeetingInfo(
            java.util.Map<String, CollectionHoldString> meetingInfo) {
