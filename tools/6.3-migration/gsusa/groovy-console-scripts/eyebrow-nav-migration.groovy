...
String PATH = "/content";
String RESOURCE_TYPE = 'gsusa/components/eyebrow-nav';
			    ...
			    if(!node.hasNode("navs")){
			     ...
			     try{
	                 ...
	                 for(int i = 0; i < values.length; i++){
						...
						String newWindow = linkProperties.length >=3 ? linkProperties[2] : ""
	                    String clazz = linkProperties.length >= 4 ? linkProperties[3] : ""	                    
	                    String sticky = linkProperties.length >=5 ? linkProperties[4] : "false"
	                    itemNode.setProperty("newWindow", Boolean.parseBoolean(newWindow))
	                    itemNode.setProperty("sticky", Boolean.parseBoolean(sticky))
