...
public class GSSearchResultExcerpt {
	...
	public static GSSearchResultExcerpt create(final GSSearchResult result, final Set<String> excerptPropNames,
		...
		final List<GSSearchResultExcerpt> excerpt = new ArrayList<GSSearchResultExcerpt>();
		...
		return (GSSearchResultExcerpt) excerpt.get(0);
	}
	...
	private static GSSearchResultExcerpt createGSSearchResultExcerpt(Property property, String relPath, Row row,
			final int maxLength)
			throws RepositoryException {
		...
		public static HTMLEditorKit.Parser getInstance() {
			return new HTMLEditorKit.Parser() {
				public void parse(Reader r, HTMLEditorKit.ParserCallback cb, boolean ignoreCharSet) throws IOException {
					new DocumentParser(GSSearchResultExcerpt.DTDEx.INSTANCE).parse(r, cb, ignoreCharSet);
				}
			};
		}
	}
	...
	private static final class DTDEx extends DTD {
		...
		private static final class ParserDelegatorEx extends ParserDelegator {
			...
			static DTD createDTD() {
				DTD dtd = new GSSearchResultExcerpt.DTDEx(null);
