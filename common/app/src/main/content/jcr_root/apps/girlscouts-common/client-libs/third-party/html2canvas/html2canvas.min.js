    ...
    return createIframeContainer(ownerDocument, bounds).then(function (cloneIframeContainer) {
        ...
        if(!window.html2canvasCloneExists){
            ...
            documentClone.close();
        		...
        		//documentClone.open();
	        //documentClone.body.replaceWith(cloner.documentElement.body);
        	
        	documentClone.body.replaceWith(cloner.documentElement.getElementsByTagName('body')[0]); // Works.
        //	documentClone.getElementsByClassName('CanvasImageOutputArea')[0].replaceWith(cloner.documentElement.getElementsByClassName('CanvasImageOutputArea')[0]);
        	
        	
	        //documentClone.close();
	        //documentClone.replaceChild(documentClone.adoptNode(cloner.documentElement.getElementsByTagName('body')[0]), documentClone.documentElement.getElementsByTagName('body')[0]);
        }
