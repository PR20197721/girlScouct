    ...
    <div id="rightbox" class="box">
        ...
        <form class="coral-Form coral-Form--vertical" name="login" method="POST" id="login" action="<%= xssAPI.getValidHref(urlLogin) %>" novalidate="novalidate">
            ...
            <div class="coral-Form-fieldwrapper">
                <input is="coral-textfield" class="coral-Form-field" id="username" name="j_username" type="text" autofocus="autofocus" pattern=".*" placeholder="<%= userPlaceholder %>" spellcheck="false" autocomplete="<%= autocomplete %>">
            </div>
            <div class="coral-Form-fieldwrapper">
                <input is="coral-textfield" class="coral-Form-field" id="password" name="j_password" type="password"  placeholder="<%= isLogin ? loginPasswordPlaceholder : changePasswordPlaceholder %>" spellcheck="false" autocomplete="<%= autocomplete %>">
            </div>
            <div class="coral-Form-fieldwrapper">
                <input is="coral-textfield" class="coral-Form-field" id="new_password" name="<%= isLogin ? "" : "j_newpassword" %>" type="password"  placeholder="<%= newPasswordPlaceholder %>" spellcheck="false" autocomplete="false" <%= isLogin ? "hidden" : "" %>>
            </div>
            <div class="coral-Form-fieldwrapper">
                <input is="coral-textfield" class="coral-Form-field" id="confirm_password" name="" type="password"  placeholder="<%= confirmPasswordPlaceholder %>" spellcheck="false" autocomplete="false" <%= isLogin ? "hidden" : "" %>>
            </div>
...
<div id="footer">
    ...
    %><span><%= xssAPI.encodeForHTML(i18n.getVar(text, "{0} is the product year", productInfo.getYear())) %></span><%
        }
    %><ul id="usage-box"><%
