...
curl -u 'admin:e$Fz&rsBS.XZk$6F'  -X POST http://52.1.73.148:4503/crx/packmgr/service/.json/etc/packages/Girl%20Scouts/girlscouts-vtk-app-$VERSION.zip?cmd=delete
