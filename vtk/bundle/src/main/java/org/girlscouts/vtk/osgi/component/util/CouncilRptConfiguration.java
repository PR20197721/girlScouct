...
public @interface CouncilRptConfiguration {
    @AttributeDefinition(name = "From:", description = "From Email Address", type = AttributeType.STRING) String fromEmailAddress();

    @AttributeDefinition(name = "To:", description = "To Email Addresses") String[] toEmailAddresses();
