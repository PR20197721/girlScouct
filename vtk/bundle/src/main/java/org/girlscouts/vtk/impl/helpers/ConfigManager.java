...
@Properties ({
    ...
    @Property(name="councilMapping", cardinality=Integer.MAX_VALUE, label="Council Branch Mapping", description="Defines mappings between a council ID and a content branch. Format: council id::content branch. e.g. 12::gateway::http://www.girlscouts-gateway.org"),
    @Property(name="defaultMapping", label="Default Mapping", description="Default branch if council mapping not found. Format: council id:content branch:url. e.g. girlscouts-usa::http://www.girlscouts.org/")
})
