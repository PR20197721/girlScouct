...
public class tester3 {
	...
	public static void main(String[] args) {
		 ...
		 * for(int i=0;i<campaignIds.size();i++){ System.err.println(
		 * "CampID: "+ campaignIds.get(i));
		 * 
		 * 
		 * if( i==0 ){ me.getCampaign(apiConfig, "701Z0000000WZA7");
		...
		// System.err.println("WhoAMI? "+ _user.getName() + " : "+
		// _user.getEmail());
