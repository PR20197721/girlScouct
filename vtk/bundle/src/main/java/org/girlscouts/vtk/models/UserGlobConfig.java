...
public class UserGlobConfig {
	...
	//temp aperio
	@Field private String masterSalesForceToken, masterSalesForceRefreshToken;
	...
	public void setMasterSalesForceRefreshToken(String masterSalesForceRefreshToken) {
