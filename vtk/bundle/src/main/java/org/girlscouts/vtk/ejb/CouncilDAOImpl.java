...
public class CouncilDAOImpl implements CouncilDAO {
	...
	public Council findCouncil(User user, String councilId)
		...
		Session session = null; ResourceResolver rr= null;
		        ...
		        try{
	   		        ...
	   		        for(String council: councils){
				        ...
				        for (javax.jcr.query.RowIterator it = result.getRows(); it.hasNext(); ) {
				            ...
				            try{ yearPlanName=n1.getProperty("name").getValue().getString();}catch(Exception e){}				               
...
if( rr!=null ){
	...
	public java.util.List<String> getCouncils( String currYearPath ){
		...
		Session session= null; ResourceResolver resourceResolver= null;
		try{
