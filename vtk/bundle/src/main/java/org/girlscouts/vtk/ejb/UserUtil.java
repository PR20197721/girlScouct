...
public class UserUtil {
	...
	/*
	 * public boolean hasAccess(Troop troop, String mySessionId, int
	 * permissionId) {
	 * 
	 * if (!hasPermission(troop, permissionId)) return false;
	 * 
	 * 
	 * if (!isCurrentTroopId(troop, mySessionId)) return false;
	 * 
	 * 
	 * return true; }
	 */
