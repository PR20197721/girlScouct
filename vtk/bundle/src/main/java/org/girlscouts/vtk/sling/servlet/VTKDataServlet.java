...
@SlingServlet(label = "Girl Scouts VTK Data Servlet", description = "Girl Scouts VTK Data Servlet", paths = {"/bin/vtk-data"})
public class VTKDataServlet extends SlingSafeMethodsServlet {
    ...
    private void forwardYearPlan(SlingHttpServletRequest request, SlingHttpServletResponse response, String id) throws ServletException, IOException {
    ...
    private void forwardMeeting(SlingHttpServletRequest request, SlingHttpServletResponse response, String id, String meetingId) throws ServletException, IOException {
        RequestDispatcher dispatcher = request.getRequestDispatcher("/content/girlscouts-vtk/controllers/vtk.controller.html");
