...
import org.girlscouts.vtk.osgi.conf.SalesForceTroopsResponseCacheConfig;
...
@Component(service = {SalesForceTroopsResponseCache.class}, immediate = true, name = "org.girlscouts.vtk.osgi.cache.impl.SalesForceTroopsResponseCacheImpl")
@Designate(ocd = SalesForceTroopsResponseCacheConfig.class)
public class SalesForceTroopsResponseCacheImpl extends BasicGirlScoutsService implements SalesForceTroopsResponseCache {

    private static Logger log = LoggerFactory.getLogger(SalesForceTroopsResponseCacheImpl.class);
