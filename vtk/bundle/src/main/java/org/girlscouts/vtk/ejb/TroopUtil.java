...
public class TroopUtil {
    ...
    public void selectYearPlan_vtk1(User user, Troop troop, String yearPlanPath, String planName) throws java.lang.IllegalAccessException, VtkYearPlanChangeException, VtkException {
        // permission to update
        ...
        try {
            ...
            if (oldPlan == null || oldPlan.getMeetingEvents() == null || oldPlan.getMeetingEvents().size() <= 0 || oldPlan.getSchedule() == null || oldPlan.getSchedule().getDates().equals("")) {
        ...
        if (troop.getYearPlan().getActivities() != null) {
            ...
            for (int i = 0; i < troop.getYearPlan().getActivities().size(); i++) {
                if (new java.util.Date().before(troop.getYearPlan().getActivities().get(i).getDate())) {
                    activityToRm.add(troop.getYearPlan().getActivities().get(i));
                }
            }
