...
public class PermissionConstants {
    ...
    public static final int[] GROUP_LEADER_PERMISSIONS = new int[]{PERMISSION_ADD_YEARPLAN_ID, PERMISSION_RM_YEARPLAN_ID, PERMISSION_ADD_ACTIVITY_ID, PERMISSION_EDIT_ACTIVITY_ID, PERMISSION_RM_ACTIVITY_ID, PERMISSION_EDIT_MEETING_ID, PERMISSION_VIEW_MILESTONE_ID, PERMISSION_ADD_MEETING_ID, PERMISSION_CREATE_MEETING_ID, PERMISSION_REMOVE_MEETING_ID, PERMISSION_SEND_EMAIL_MT_ID, PERMISSION_SEND_EMAIL_ACT_ID, PERMISSION_VIEW_ACTIVITY_PLAN_ID, PERMISSION_EDIT_ATTENDANCE_ID, PERMISSION_REMOVE_MEETING_ID, PERMISSION_EDIT_TROOP_IMG_ID, PERMISSION_CAN_VIEW_MEMBER_DETAIL_TROOP_ID, PERMISSION_VIEW_FINANCE_ID, PERMISSION_EDIT_FINANCE_ID, PERMISSION_SEND_EMAIL_ALL_TROOP_PARENTS_ID};
    ...
    public static final int[] GROUP_MEMBER_1G_PERMISSIONS = new int[]{PERMISSION_VIEW_YEARPLAN_ID, PERMISSION_VIEW_MEETING_ID, PERMISSION_VIEW_TROOP_ID, PERMISSION_CAN_VIEW_OWN_CHILD_DETAIL_TROOP_ID, PERMISSION_VIEW_FINANCE_ID};
    ...
    public static final int[] GROUP_MEMBER_COUNCIL_PERMISSIONS = ArrayUtils.addAll(GROUP_LEADER_PERMISSIONS, PERMISSION_CAN_VIEW_MEMBER_DETAIL_TROOP_ID, PERMISSION_EDIT_FINANCE_ID, PERMISSION_VIEW_REPORT_ID, PERMISSION_EDIT_MILESTONE_ID, PERMISSION_EDIT_FINANCE_FORM_ID, PERMISSION_DELETE_FINANCE);
    public static final int GROUP_FINANCE_ADMIN = 1;
    public static final String GROUP_FINANCE_DISPLAY = "Finance Administrator";
    public static final int[] GROUP_FINANCE_PERMISSIONS = new int[]{PERMISSION_VIEW_YEARPLAN_ID, PERMISSION_VIEW_MEETING_ID, PERMISSION_VIEW_TROOP_ID, PERMISSION_CAN_VIEW_OWN_CHILD_DETAIL_TROOP_ID, PERMISSION_VIEW_FINANCE_ID, PERMISSION_EDIT_FINANCE_ID};
