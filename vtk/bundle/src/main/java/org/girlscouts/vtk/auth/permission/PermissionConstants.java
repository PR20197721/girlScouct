...
public class PermissionConstants {
    ...
    public static final int[] GROUP_LEADER_PERMISSIONS = new int[] {
      ...
      PERMISSION_EDIT_MEETING_ID,PERMISSION_ADD_MEETING_ID,PERMISSION_REPLACE_MEETING_ID,PERMISSION_MOVE_MEETING_ID ,PERMISSION_CANCEL_MEETING_ID ,PERMISSION_REMOVE_MEETING_ID, PERMISSION_UPDATE_MEETING_ID
    };
