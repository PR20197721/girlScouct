...
//	public static final int[] GROUP_MEMBER_COUNCIL_PERMISSIONS = ArrayUtils.addAll(new int[] {PERMISSION_EDIT_FINANCE_ID, PERMISSION_VIEW_REPORT_ID, PERMISSION_VIEW_MILESTONE_ID}, GROUP_LEADER_PERMISSIONS, PERMISSION_EDIT_FINANCE_FORM_ID);
}
