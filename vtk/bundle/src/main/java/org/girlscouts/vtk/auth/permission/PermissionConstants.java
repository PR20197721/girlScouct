...
public class PermissionConstants {
	...
	public static final int[] GROUP_LEADER_PERMISSIONS = new int[] {
			...
			PERMISSION_EDIT_TROOP_ID,PERMISSION_VIEW_MILESTONE_ID,
			PERMISSION_VIEW_FINANCE_ID, PERMISSION_EDIT_MEETING_ID,
			PERMISSION_ADD_MEETING_ID, PERMISSION_CREATE_MEETING_ID,
			PERMISSION_REMOVE_MEETING_ID,PERMISSION_SEND_EMAIL_ID,
			PERMISSION_VIEW_ACTIVITY_PLAN_ID,PERMISSION_VIEW_ATTENDANCE_ID};
	...
	public static final int[] GROUP_MEMBER_COUNCIL_PERMISSIONS = ArrayUtils.addAll(new int[] {PERMISSION_VIEW_FINANCE_ID, PERMISSION_EDIT_MILESTONE_ID}, GROUP_LEADER_PERMISSIONS);
}
