...
public class SalesForceContactsResponseCacheImpl extends BasicGirlScoutsService implements SalesForceContactsResponseCache{

    private static Logger log = LoggerFactory.getLogger(SalesForceContactsResponseCacheImpl.class);
