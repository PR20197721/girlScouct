...
@Designate(ocd = VTKMeetingLibraryCacheImpl.Config.class)
public class VTKMeetingLibraryCacheImpl implements VTKMeetingLibraryCache {
    ...
    @ObjectClassDefinition(name = "Girl Scouts VTK Meeting Library cache configuration", description = "Girl Scouts VTK Meeting Library cache configuration")
