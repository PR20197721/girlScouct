        ...
        return (React.createElement("div", { className: "meeting" },
            ...
            React.createElement("div", { className: "body" },
                React.createElement("ul", null,
                    ...
                    React.createElement("li", { style: { textAlign: "center" } }, (this.props.outdoor) ? React.createElement("img", { src: tree_1.tree, style: { 'width': '60px', 'height': '60px' }, alt: "" }) : null),
                    React.createElement("li", { style: { textAlign: "right" } },
                        React.createElement("img", { src: "/content/dam/girlscouts-vtk/local/icon/meetings/" + this.props.id + ".png", alt: "" }),
                        " ")))));
    };
    return Meeting;
}(React.Component));
...
var Meetings = (function (_super) {
    ...
    Meetings.prototype.render = function () {
        return (React.createElement("div", { className: "list-meetings" }, (this.props.meetings) ? this.props.meetings.map(function (meeting, idx) { return React.createElement(meeting_1.default, __assign({ key: meeting.id, idx: idx }, meeting)); }) : null));
    };
    return Meetings;
}(React.Component));
