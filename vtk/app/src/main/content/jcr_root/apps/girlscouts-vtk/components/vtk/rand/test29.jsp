...
<CommentBox url="/content/girlscouts-vtk/controllers/vtk.rand.test13_2.html" pollInterval={2000} />,
...
React.render(
//<CommentBox url="/content/girlscouts-vtk/controllers/vtk.rand.test13_2.html" />,
//console.log(data); 
