 ...
 * </p>
 * 
 * @class girlscouts.components.TagInputField
 ...
 */
girlscouts.components.TagInputField = CQ.Ext.extend(CQ.form.CompositeField, {
     ...
     * <pre><code>
 {
    ...
    constructor: function(config) {
        ...
        girlscouts.components.TagInputField.superclass.constructor.call(this, config);
    },
    ...
    initComponent: function() {
        ...
        girlscouts.components.TagInputField.superclass.initComponent.call(this);

        this.addEvents(
            /**
             * @event addtag
             * Fires when a tag was added to the value of this field (not fired upon setValue)
             * @param {girlscouts.components.TagInputField} field This tag input field
     ...
     */
    onRender: function(e) {
        girlscouts.components.TagInputField.superclass.onRender.apply(this, arguments);
        ...
        try {
            if (url) {
                ...
                if (CQ.HTTP.isOk(response)) {
                    ...
                    CQ.Log.debug("girlscouts.components.TagInputField#loadTags: no response for {0}, empty data}", url);
                    return null;
                }
            }
        } catch (e) {
            CQ.Log.warn("girlscouts.components.TagInputField#loadTags: {0}", e.message);
            return null;
        }
