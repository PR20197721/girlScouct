            ...
            <form class="cmxform" id="signupForm">
                ...
                <div class="row">
                    ...
                    <div class="small-24 large-3 medium-3 columns date">
                        <input type="text" name="newCustActivity_date" id="newCustActivity_date"
                               value="<%=VtkUtil.formatDate(VtkUtil.FORMAT_MMddYYYY, activity.getDate())%>"
                               placeholder="mm/dd/yyyy" class="date calendarField" onchange="cngTimeFlag()"/>
                    </div>
                    ...
                    <div class="small-16 medium-2 large-2 columns">
                        <input type="text" name="newCustActivity_startTime" id="newCustActivity_startTime"
                    ...
                    <div class="small-8 medium-2 large-2 columns">
                        ...
                        <select id="newCustActivity_startTime_AP" class="ampm" onchange="cngTimeFlag()">
                            ...
                            <option value="PM" <%=VtkUtil.formatDate(VtkUtil.FORMAT_AMPM, activity.getDate()).toUpperCase().trim().equals("PM") ? "SELECTED" : ""%>>
                                PM
                            </option>
                        </select>
                    </div>
                    <div class="small-16 medium-2 large-2 columns">
                        <input type="text" id="newCustActivity_endTime"
                               value="<%= VtkUtil.formatDate(VtkUtil.FORMAT_hhmm_AMPM, activity.getEndDate())%>"/>
                    </div>
                    <div class="small-8 medium-2 large-2 columns">
                        <select id="newCustActivity_endTime_AP" class="ampm">
                            <option value="AM" <%=VtkUtil.formatDate(VtkUtil.FORMAT_AMPM, activity.getEndDate()).toUpperCase().trim().equals("AM") ? "SELECTED" : "" %>>
                                AM
                            </option>
                            <option value="PM" <%=VtkUtil.formatDate(VtkUtil.FORMAT_AMPM, activity.getEndDate()).toUpperCase().trim().equals("PM") ? "SELECTED" : "" %>>
                                PM
                            </option>
                        </select>
                    </div>
