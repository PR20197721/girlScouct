                        ...
                        <div id="mainContent">
                            <div class="par parsys">
                                <div class="title section">
                                    <h1>SSO Logout page</h1>
                                </div>
                                <div class="text parbase section">
                                    <div id="container">Log out successful</div>
                                    <% 
                                    ...
                                    <ul>
                                            <li>AEM Principal Name: <%=principalName%></li>
                                            <li>First Name: <%=firstName%></li>
                                            <li>Last Name: <%=lastName%></li>
                                            <li>Email: <%=email%></li>
                                            <li>GS Global ID: <%=gsGlobalId%></li>
                                            <li>GS User Type: <%=gsUserType%></li>
                                    </ul>
                                    <h3>
                                        Redirecting to SSO POC landing page after <span id="countdown">15</span> seconds
                                    </h3>
                                    <!-- JavaScript part -->
                                    <script type="text/javascript">            
