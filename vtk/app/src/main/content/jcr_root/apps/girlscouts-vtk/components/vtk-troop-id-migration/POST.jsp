<%@page session="false" import="com.day.cq.commons.jcr.JcrUtil,
...
%>stopped<%
    ...
    MigrateVtkTroopIdThread wft = new MigrateVtkTroopIdThread(getServletContext(), repository, dryRun, backup);
...
%><%!
    public class MigrateVtkTroopIdThread implements Runnable {
        ...
        public MigrateVtkTroopIdThread(ServletContext ctxt, SlingRepository repository, boolean dryRun, boolean backup) {
            this.ctxt = ctxt;
