...
<div class="columns medium-20 small-centered">
    ...
    <form class="clearfix" action="/content/girlscouts-vtk/controllers/vtk.controller.html" method="POST"
          id="MileStoneForm">
        ...
        <section class="row">
            ...
            <div class="column large-4 large-push-1 medium-4 medium-push-1 small-8">
                <input type="text" id="date<%=i %>" class="datepicker" placeholder="mm/dd/yyyy" name="ms_date[]"
            ...
            <div class="column large-2 large-pull-5 medium-2 medium-pull-5 small-1 small-pull-2">
                <input type="checkbox" id="ch_<%=i %>"
                       name="show_ch[]"<%=milestones.get(i).getShow() != null && milestones.get(i).getShow().booleanValue() ? "checked" : "unchecked" %> /><label
                    for="ch_<%=i %>"></label>
            </div>
        </section>
        <%
        ...
        <section class="row">
            <div class="column large-10">
                <a onclick="newEntry()" class="add-btn" title="add-entry"><i class="icon-button-circle-plus"></i>Add a
                    Milestone</a>
            </div>
        </section>
        <section class="row">
