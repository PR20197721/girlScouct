<%@ page
        import="org.girlscouts.vtk.osgi.component.util.MeetingUtil, org.girlscouts.vtk.models.MeetingE,  org.girlscouts.vtk.models.YearPlanComponent" %>
            ...
            <form id="frmCalElem">
                ...
                <section class='row clearfix'>
                    <div class="column small-6">
                        <input type="text" id="cngTime0" value="<%= VtkUtil.formatDate(VtkUtil.FORMAT_hhmm,date) %>"
                               name="cngDate0"/>
                    </div>
...
<script>
    ...
    var tabsVtk = (function () {
        ...
        function goto(id) {
            ...
            var el = tree.filter(function (item) {
                return item.name == id
            });
