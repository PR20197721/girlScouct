...
<div id="theActivity">
    ...
    <script type="text/javascript">
        ...
        var ActivityCommunication = React.createClass({
            displayName: "Activity communication",
            render: function () {
                    ...
                    return (
                        React.createElement("li", null,
                            React.createElement("a", {
                                    ...
                                    title: "Activity Reminder Email"
                                }, "Edit/Send Invitation/Reminder"
                    ...
                    return (
                        React.createElement("li", null,
                            React.createElement("a", {
                                    ...
                                    "data-reveal-id": "modal_view_sent_emails"
                                }, "Invitation/Reminder"
        ...
        var AttendanceAchievement = React.createClass({
            displayName: "Attendance and Achievement",
            render: function () {
                ...
                return (
                    React.createElement("li", null,
                        React.createElement("a", {
                            ...
                            className: "<%=( user.getCurrentYear().equals( VtkUtil.getCurrentGSYear()+"")) ? "" : "vtkDisableA"%>",
                            href: "/content/girlscouts-vtk/controllers/vtk.include.modals.modal_attendance.html?eType=ACTIVITY&mid=" + this.props.data.uid + "&isAch=" + isArch + "&mName=" + this.props.data.name
                        }, "Record Attendance"),
        ...
        var ViewEmailWithPermis = React.createClass({
            displayName: "ViewEmailWithPermis",
            render: function () {
                if (sentEmails > 0) {
        ...
        var ViewEmailNoPermis = React.createClass({
            displayName: "ViewEmailNoPermis",
            render: function () {
                if (sendEmails > 0) {
                    return (
                        React.createElement("li", null,
        ...
        var NavDirectionNext = React.createClass({
            displayName: "NavDirectionNext",
            render: function () {
                if (activityHelper.nextDate != 0 && activityHelper.nextDate != null) {
                    return (
                        React.createElement("a", {
                            className: "direction next",
                            href: "/content/girlscouts-vtk/en/vtk.details.html?elem=" + activityHelper.nextDate
                        })
        ...
        var ActivityDate = React.createClass({
            displayName: "Prev Date",
            render: function () {
        ...
        var NavDirectionPrev = React.createClass({
            displayName: "Prev Date",
            render: function () {
                    ...
                    return (
                        React.createElement("span", null,
                            React.createElement("a", {
                                ...
                                href: "/content/girlscouts-vtk/en/vtk.details.html?elem=" + activityHelper.prevDate
                            })
                        )
                    )
                } else {
                ...
                if (this.state.data.activities != null) {
                    ...
                    return (
                        React.createElement(Activity, {
                            data: x,
                            meetingTitle: x.name,
                            meetingModMONTH: moment.tz(x.date, "America/New_York").format('MMMM'),
                            meetingModDAY: moment.tz(x.date, "America/New_York").format('DD'),
                            meetingModHOUR: moment.tz(x.date, "America/New_York").format('h:mm a')
                        })
        ...
        ReactDOM.render(
            React.createElement(CommentBox, {
                url: "/content/girlscouts-vtk/controllers/vtk.controller.html?reactActivity=x" + getElem(),
                pollInterval: 10000
            }),
                ...
                return (
                    React.createElement("div", {className: "section-wrapper"},
                            ...
                            React.createElement("div", {className: "meeting-navigation activity-navigation row collapse"},
                                ...
                                React.createElement("div", {className: "column"},
                                    ...
                                    React.createElement(ActivityDate, {
                                        meetingModMONTH: this.props.meetingModMONTH,
                        ...
                        React.createElement("div", {
                                className: "column large-20 medium-20 large-centered medium-centered clearfix",
                                id: "main-info"
                            },
