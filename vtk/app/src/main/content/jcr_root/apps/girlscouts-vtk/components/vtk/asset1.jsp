    ...
    <div class="content">
        <div class="row modalHeader">
            ...
            <div class="small-4 medium-2 large-2 columns">
                <div class="warning"><img src="/etc/designs/girlscouts-vtk/clientlibs/css/images/warning-small.png"
                                          width="20" height="20" align="left"/></div>
            </div>
            ...
            <div class="row modalBody">
                <div class="small-24 medium-24 large-24 columns">
                    <ul>
                        ...
                        <li class="checked">
                            <%=displayName%> (<img
                                src="/etc/designs/girlscouts-vtk/clientlibs/css/images/checked-small.png" width="20"
                                height="20"/> added)
                            <a href="javascript:void(0)"
                               onclick="rmAid('<%=aidId %>', '<%=_comp.getUid()%>', '<%=request.getParameter("aidName")%>')">remove</a>
                        </li>
                        <%
                        } else if (!isActivity) {
                        %>
                        <li><a href="javascript:void(0)"
                               onclick="assignAid('<%=aidId %>', '<%=_comp.getUid()%>', '<%=request.getParameter("aidName")%>')"><%=displayName%>
                        </a></li>
                        <%
                                }
                            }
