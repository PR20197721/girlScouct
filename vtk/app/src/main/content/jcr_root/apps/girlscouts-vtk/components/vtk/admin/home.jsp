                ...
                <div class="text parbase nopadding section">
                    <table border="0" cellpadding="0" cellspacing="0"
                        ...
                        <tr style="background-color: white;border: none;">
                            <td>Go here to build you own action-packed year
                        ...
                        <tr>
                            <td>
                                ...
                                Existing Plans:<br/>
                                <a href="/content/girlscouts-vtk/en/vtk.admin.plan.html">::<%=selectedTroop.getYearPlan().getName() %>
    ...
    <li style="padding:25px;">
        <div class="text parbase nopadding section">
            <table border="0" cellpadding="0" cellspacing="0" style="border: none;">
                ...
                <tr style="background-color: white;border: none;">
                    <td>Go here to change milestones
                    </td>
                </tr>
                </tbody>
            </table>
    ...
    <li style="padding:25px;">
        <div class="text parbase nopadding section">
            <table border="0" cellpadding="0" cellspacing="0" style="border: none;">
                ...
                <tr style="background-color: white;border: none;">
                    <td>Change troop picture (GSWV-49)
                    </td>
                </tr>
                </tbody>
            </table>
