<%@ page import="org.girlscouts.vtk.osgi.service.GirlScoutsSalesForceService, java.util.StringTokenizer" %>
            ...
            <div class="row bg">
                <div class="column large-12">
                    <ul class="large-block-grid-2 small-block-grid-2">
                        ...
                        <li><%=_troop.getYearPlan().getName() %>
                        </li>
                        <li><strong>Plan Customized:</strong></li>
                        <li><%= (_troop.getYearPlan().getAltered() != null && _troop.getYearPlan().getAltered().equals("true")) ? "Yes" : "No" %>
                        </li>
                        <li><strong>Badges Earned:</strong></li>
                        <li>
                            <div id="rpt_badges_earned"></div>
                        </li>
                    </ul>
                </div>
                <div class="column large-12">
                    <ul class="large-block-grid-2 small-block-grid-2">
                        ...
                        <li>
                            <div id="meeting_activities_added"></div>
                        </li>
                        <li><strong>Calendar Activities Added:</strong></li>
                        <li>
                            <div id="calendar_activities_added"></div>
                        </li>
                    </ul>
                </div>
            </div>
