...
girlscouts.components.VTKResourcesCategoryWidget = CQ.Ext.extend(CQ.form.CompositeField, {
...
// register xtype
CQ.Ext.reg('vtkresourcescategory', girlscouts.components.VTKResourcesCategoryWidget);
