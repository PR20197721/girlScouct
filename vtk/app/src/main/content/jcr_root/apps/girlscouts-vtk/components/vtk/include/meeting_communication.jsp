<section className="column large-20 medium-20 large-centered medium-centered">
  ...
  <ul className="large-block-grid-2 medium-block-grid-2 small-block-grid-2">
   <li><a href="javascript:loadModalPage('/content/girlscouts-vtk/controllers/vtk.reminderEmail.html', false, null, true)" title="Meeting Reminder Email">Meeting Reminder Email</a></li>
