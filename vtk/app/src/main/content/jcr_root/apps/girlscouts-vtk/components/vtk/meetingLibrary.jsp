...
<div class="small-4 medium-2 large-2 columns meeting_library">
    <div class="warning"><img src="/etc/designs/girlscouts-vtk/clientlibs/css/images/warning-small.png" width="20"
                              height="20" align="left"/></div>
</div>
<div class="small-20 medium-22 large-22 columns">
    ...
    <%
        ...
        try {
            sched = meetingUtil.getYearPlanSched(user, selectedTroop, selectedTroop.getYearPlan(), true, true);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        <div class="content meeting-library row">
            ...
            <div id="vtk-meeting-filter" class="content">
                            ...
                            <tr>
                                <td>
                                    <div class="__search row"
                                         style="border:1px solid gray; border-radius:6px; overflow:hidden">
                ...
                <div class="vtk-meeting-group" style="display:none;">
                    <div class="main-filter column small-22 small-centered" style="display:table; padding-left:0;">
                        <div class="row">
                            ...
                            <div class="column small-24" id="vtk-meeting-group-type" style="display:none">
                                <div class="vtk-meeting-filter_title"><span>2.</span> Select the type of meeting plan
                                    you want
                                </div>
                                <div class="row">
                    ...
                    <div class="list-of-categories column small-22 small-centered" style="display:none;padding-left:0;">
                        <div class="row">
                            <div class="column small-24">
                                <div class="vtk-meeting-filter_title"><span>3.</span> Select your <span
                                    ...
                                    <div class="small-24 medium-12 large-6 column selection-box  <%= !itrCats.hasNext() ? "end" : "" %>"
                                        ...
                                        <label for="<%= id%>"><span></span>
                                            <p>
                                                ...
                                                <span style="font-size:10px;color:#F9A61A;font-weight:bold;background:none;display:inline-block; padding-top: 8px;"
                                                      id="vtkCatItem_<%= id%>">
 							NEW
 						</span>
                                                <% } %>
			...
			overflow: hidden;">
                    <div class="vtk-float-submit">
                        ...
                        <input class="button tiny inactive-button clear-meeting-filter-result" type="button"
                               value="CLEAR SELECTED MEETINGS"/>
                        <%if (request.getParameter("newCustYr") != null) { %>
                        <input class="button tiny inactive-button add-to-year-plan" type="button"
                               value="ADD TO YEAR PLAN" onclick="createCustPlan(null)"/>
                        <%} else { %>
                        <input class="button tiny inactive-button add-to-year-plan" type="submit"
                               value="ADD TO YEAR PLAN"/>
                        <%}//end else %>
                        <%}%>
                    </div>
                </div>
                            ...
                            <div style="display:table;min-height:110px; width: inherit;">
                                <div style="display:table-cell;height:inherit;vertical-align:middle; text-align:center;">
                                    ...
                                    <div class="middle-checkbox" style="text-align:center;">
                                        ...
                                        <table>
                                            <tr>
                                                <td>
                                                    <%if (request.getParameter("isReplaceMeeting") == null) {%>
                                                    <input type="checkbox" name="addMeetingMulti"
                                                           id="<%=meeting.getPath()%>_<%=i%>"
                                                ...
                                                <td>
                                                    <%if (request.getParameter("isReplaceMeeting") != null) {%>
                                                    <p class="select-meeting-withaction" style="display:none"
                                                       onclick="cngMeeting('<%=meeting.getPath()%>')">SELECT MEETING</p>
                                                    <%} else {%>
                                    ...
                                    <img src="/etc/designs/girlscouts-vtk/clientlibs/css/images/check.png" width="10"
                                         height="15"> <i class="included">Included in Year Plan</i>
                                    <% }%>
                                </div>
                            </div>
                        </div>
