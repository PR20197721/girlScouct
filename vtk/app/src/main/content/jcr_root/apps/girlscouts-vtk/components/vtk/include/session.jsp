...
%>
<a href="/content/girlscouts-vtk/en/vtk.controller.html?resetCal=true" class="hide-for-print">RESET CAL</a>

  <%
    if( user.getErrCode()!=null && user.getErrCode().equals("111") ){
    %>
      <div class="error">Warning: another user is currently logged into this account or you have no permissions. To continue, please logout and login again.  (This will cause the other user to be logged out.) error 111-in db</div>
    <%
    }     
    ...
    if( user.getErrCode()!=null && user.getErrCode().equals("112") ){
      %>
        <div class="error">Warning: another user is currently logged into this account or you have no permissions. To continue, please logout and login again.  (This will cause the other user to be logged out.) error 112-another user</div>
      <%
      user.setRefresh(true);
      return;
    } 
