...
<%!
	...
	String[] ENABLED_FEATURES = new String[] { SHOW_VALID_SF_USER_FEATURE, SHOW_BETA_FEATURE, SHOW_FINANCE_FEATURE, SHOW_PARENT_FEATURE, SHOW_ADMIN_FEATURE, SHOW_PERMISSION_FEATURE};
