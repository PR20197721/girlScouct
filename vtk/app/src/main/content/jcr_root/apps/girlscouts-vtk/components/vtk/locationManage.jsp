...
<div class="locationListing columns">
    ...
    <div class="locationResultElement">
        <div class="row">
            ...
            <div class="small-10 columns"><h3><%=location.getName() %>
            </h3></div>
            ...
            <div class="small-24 columns">
                <div class="locationList">
                    <ul class="clearfix small-block-grid-3">
                        ...
                        %>
                        <li>
                            <input type="checkbox" id="chbx_<%=i%>_<%=num%>" name="<%=location.getName() %>"
                                   value="<%=date%>" <%= mLoc.equals(location.getPath()) ? "CHECKED" : ""%> />
                        ...
                        <li><%= mLoc.equals(location.getPath()) ? "Activity day past" : ""%>
                            <del><%=VtkUtil.formatDate(VtkUtil.FORMAT_MMddYYYY, date) %>
                            </del>
                        </li>
                        <%
                                }
