...
<div id="panelWrapper" class="row content meeting-detail">
 <%@include file="include/utility_nav.jsp"%>
  <div class="columns large-20 large-centered">
  	<a href="/content/girlscouts-vtk/en/vtk.include.html?qtr=1">Q1</a> || 
    ...
    <!-- current income -->
      <div class="small-24 large-12 columns">
        ...
        <div class="small-24 large-12 columns"><%=String.format(financeFieldTag, "starting_balance", "starting_balance", FORMAT_COST_CENTS.format(finance.getStartingBalance())) %></div>
        </div>
      <div class="row">
        <div class="small-24 large-12 columns">Troop Dues:</div>
        <div class="small-24 large-12 columns"><%=String.format(financeFieldTag, "troop_dues", "troop_dues", FORMAT_COST_CENTS.format(finance.getTroopDues())) %></div>
      </div>
      <div class="row">
        <div class="small-24 large-12 columns">Sponsorship/Donations:</div>
        <div class="small-24 large-12 columns"><%=String.format(financeFieldTag, "sponsorship_donations", "sponsorship_donations", FORMAT_COST_CENTS.format(finance.getSponsorshipDonations())) %></div>
      </div>
      <div class="row">
        <div class="small-24 large-12 columns">Product Sales Proceeds:</div>
        <div class="small-24 large-12 columns"><%=String.format(financeFieldTag, "product_sales_proceeds", "product_sales_proceeds", FORMAT_COST_CENTS.format(finance.getProductSalesProceeds())) %></div>
      </div>
      <div class="row">
        <div class="small-24 large-12 columns">Approved Money-Earnings Activities:</div>
        <div class="small-24 large-12 columns"><%=String.format(financeFieldTag, "amea", "amea", FORMAT_COST_CENTS.format(finance.getApprovedMoneyEarningActivity())) %></div>
      </div>
      <div class="row">
        <div class="small-24 large-12 columns">Interest on Bank Accounts:</div>
        <div class="small-24 large-12 columns"><%=String.format(financeFieldTag, "bank_interest", "bank_interest", FORMAT_COST_CENTS.format(finance.getInterestOnBankAccount())) %></div>
      </div>
      </div>
      ...
      <div class="small-24 large-12 columns">
        ...
        <div class="small-24 large-12 columns"><%=String.format(financeFieldTag, "gsusa_registrations", "gsusa_registrations", FORMAT_COST_CENTS.format(finance.getGsusaRegistration())) %></div>
      </div>
       <div class="row">
        <div class="small-24 large-12 columns">Service Activities/Events:</div>
        <div class="small-24 large-12 columns"><%=String.format(financeFieldTag, "service_ae", "service_ae", FORMAT_COST_CENTS.format(finance.getServiceActivitiesEvents())) %></div>
      </div>
      <div class="row">
        <div class="small-24 large-12 columns">Council Programs/Camp:</div>
        <div class="small-24 large-12 columns"><%=String.format(financeFieldTag, "council_pc", "council_pc", FORMAT_COST_CENTS.format(finance.getCouncilProgramsCamp())) %></div>
      </div>
      <div class="row">
        <div class="small-24 large-12 columns">Troop Activities:</div>
        <div class="small-24 large-12 columns"><%=String.format(financeFieldTag, "troop_activities", "troop_activities", FORMAT_COST_CENTS.format(finance.getTroopActivities())) %></div>
      </div>
      <div class="row">
        <div class="small-24 large-12 columns">Troop Supplies:</div>
        <div class="small-24 large-12 columns"><%=String.format(financeFieldTag, "troop_supplies", "troop_supplies", FORMAT_COST_CENTS.format(finance.getTroopSupplies())) %></div>
      </div>
      <div class="row">
        <div class="small-24 large-12 columns">GS Store Purchase:</div>
        <div class="small-24 large-12 columns"><%=String.format(financeFieldTag, "gs_store_purchase", "gs_store_purchase", FORMAT_COST_CENTS.format(finance.getSponsorshipDonations())) %></div>
      </div>
      </div>
