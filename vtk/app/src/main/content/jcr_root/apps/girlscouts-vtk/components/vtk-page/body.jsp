...
%>
	<body onload="xx1256()" ng-app="phonecatApp" data-grid-framework="f4" data-grid-color="darksalmon" data-grid-opacity="0.5" data-grid-zindex="10" data-grid-gutterwidth="10px" data-grid-nbcols="24" class="vtk-body">
