...
$(function() {
 ...
 <form>
	...
	<br/>Start Time: ex: 18:15<input type="text" id="newCustActivity_startTime" value="18:11" style="width:100px;" />
	<br/>End Time: ex: 09:10<input type="text" id="newCustActivity_endTime" value="11:11"  style="width:100px;"/>
