...
-->
                ...
                <div class="row">
                    ...
                    <div class="searchBar columns medium-6 small-24 search-box large-6">
                        ...
                        <!--<form action="http://template.girlscouts.org/en/site-search.html" method="get">
            ...
            <div class="show-for-small small-24 columns topMessage alt">
                <div class="row vtk-login">
                    ...
                    <div class="small-12 columns">
                        <div class="small-search-hamburger">
                            <a class="search-icon">
                                <img src="/etc/designs/girlscouts-usa-green/images/search_white.png" width="21" height="21" alt="search icon" />
                            </a>
                            <a class="right-off-canvas-toggle menu-icon">
                                <img src="/etc/designs/girlscouts-usa-green/images/hamburger.png" width="22" height="28" alt="toggle hamburger side menu icon" />
                            </a>
                        </div>
                    </div>
                </div>
                <div class="row hide srch-box">
                    ...
                    <div class="small-4 columns">
                        <a class="right-off-canvas-toggle menu-icon">
                            <img src="/etc/designs/girlscouts-usa-green/images/hamburger.png" width="22" height="28" alt="right side menu hamburger icon" />
                        </a>
                    </div>
                </div>
...
-->
        ...
        <div id="headerBar" class="row collapse hide-for-small">
            ...
            <div class="global-navigation large-19 medium-23 global-nav columns small-24 large-push-5">
                ...
                <ul class="inline-list">
                    <!--
                                            <li class="">
                                                <a class="show-for-large-up menu  " href="http://template.girlscouts.org/en/about-girl-scouts/who-we-are.html">ABOUT GIRL SCOUTS</a>
                                                <a class="show-for-medium-only menu  " href="http://template.girlscouts.org/en/about-girl-scouts/who-we-are.html"> ABOUT</a>
                                            </li>
                        <li class="">
                            ...
                            <a class="show-for-medium-only menu  " href="#"> EVENTS</a>
                                            ...
                                            <li class="">
                                                <a class="show-for-large-up menu  " href="http://template.girlscouts.org/en/cookies/about-girl-scout-cookies.html">COOKIES</a>
                                                <a class="show-for-medium-only menu  " href="http://template.girlscouts.org/en/cookies/about-girl-scout-cookies.html"> COOKIES</a>
                                            </li>

                                            <li class="">
                                                <a class="show-for-large-up menu  " href="http://template.girlscouts.org/en/for-volunteers/why-volunteer.html">VOLUNTEER</a>
                                                <a class="show-for-medium-only menu  " href="http://template.girlscouts.org/en/for-volunteers/why-volunteer.html"> VOLUNTEER</a>
                                            </li>
                        <li class="">
            ...
            <!--
                            <div class="small-search-hamburger show-for-medium medium-1 columns">
                                <a class="show-for-medium right-off-canvas-toggle menu-icon">
                                    <img src="/etc/designs/girlscouts-usa-green/images/hamburger.png" width="19" height="28" alt="side menu icon">
                                </a>
                            </div>
            -->
        </div>
        ...
        <!--
                        ...
                        <div class="global-navigation global-nav">
                            ...
                            <div id="right-canvas-menu">
                                <ul class="side-nav" style="padding:0px">
                                    ...
                                    <li>
                                        <div><a href="http://template.girlscouts.org/en/about-girl-scouts/who-we-are.html"> ABOUT</a>
                                        </div>
                 ...
                 <li>
                    <div><a href="#"> EVENTS</a></div>
                                    ...
                                    <li>
                                        <div><a href="http://template.girlscouts.org/en/cookies/about-girl-scout-cookies.html"> COOKIES</a>
                                        </div>

                                    </li>

                                    <li>
                                        <div><a href="http://template.girlscouts.org/en/for-volunteers/why-volunteer.html"> VOLUNTEER</a>
                                        </div>
        ...
        <div id="right-canvas-menu-bottom">
          <ul class="side-nav">
                                ...
                                <li><div><a href="#">Shop</a></div>

                            </li>


                                <li><div><a href="#">Forms</a></div>

                            </li>


                                <li><div><a href="#">Calendar</a></div>

                            </li>


                                <li><div><a href="#">Contact</a></div>
                        ...
                        <div id="mainContent">
                            <div class="par parsys">
                                ...
                                <div class="text parbase section">
                                    ...
                                    <p>Hello!</p>
                                    <p>The Volunteer Toolkit is currently unavailable while we make some updates</p>
                                    ...
                                    <p>You can still access Your Member Profile: <a
                                       href="https://mygs.girlscouts.org/">here</a></p>

                                    <p>If you have any questions or need support, please contact the Customer Care team	                                    <p> To continue the fun with your Girl Scout(s) during this time, visit our national <a
                                        at your council.</p>
