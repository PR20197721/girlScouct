...
<table border="1">
    ...
    <%
        ...
        String sql1 = "select * from nt:unstructured where jcr:path like '" + VtkUtil.getYearPlanBase(user, selectedTroop) + councilId + "/%/users/' and ocm_classname ='org.girlscouts.vtk.ocm.JcrNode' and jcr:lastModified is null";
        ...
        String sql = "select * from nt:unstructured where jcr:path like '" + VtkUtil.getYearPlanBase(user, selectedTroop) + councilId + "/%/users/' and ocm_classname ='org.girlscouts.vtk.ocm.JcrNode'";
    ...
    <tr>
        ...
        <td>
            <div style="color:green;"><%=lastMod == null ? "" : new java.util.Date(Long.parseLong(lastMod)) %>
            </div>
        </td>
        <td>
            ...
            <%
                try {
                    ...
                    if (xx.equals("true")) {
            %>
            <div style="font-size:10px;">Plan altered: <%=xx %>
            </div>
            <%
                    }
                } catch (Exception e) {
...
<table>
    ...
    <tr>
        ...
        <td><%= yp_2plus_withTime%>
        </td>
        <td><%=(count - yp_2plus_withTime) %>
        </td>
