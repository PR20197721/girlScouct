<div class="__resource-item columns small-22 small-centered" style="display:none"
     data-value="<%=meeting.getMeetingPlanType()%>" data-id="<%=meeting.getId()%>" data-path="<%=meeting.getPath()%>">
    <%
    ...
    <div class="row __view_meeting_details" style="display:none; padding-top:20px; background-color:#f9f9f9"
         id="view_meeting_details_<%=meeting.getId()%>">
