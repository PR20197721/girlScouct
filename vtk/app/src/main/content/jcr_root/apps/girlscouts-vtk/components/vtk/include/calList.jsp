...
%>
	...
	<% } %>
		<td width="40">
                <% if( date.after(new java.util.Date() )){ %>
			<a href="#" onclick="onclick="manageCalElem('<%=date.getTime()%>')"><img src="/etc/designs/girlscouts-vtk/clientlibs/css/images/calendar-pick.png" alt="Calender" width="22" height="22"/></a>
                <% }else{ %>
