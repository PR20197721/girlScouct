...
<%
	final String MEETING_BASE = "/content/girlscouts-vtk/meetings/myyearplan2018";
	final String YEAR_PLAN_BASE = "/content/girlscouts-vtk/yearPlanTemplates/yearplan2018";
...
%>	
    <p><h1>Girl Scout VTk 2018 - 2019 Year Plan</h1></p>
	<p><h1>New</h1></p>
		<p>
