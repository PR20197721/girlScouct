...
<%
	final String MEETING_BASE = "/content/girlscouts-vtk/meetings/myyearplan2019";
	final String YEAR_PLAN_BASE = "/content/girlscouts-vtk/yearPlanTemplates/yearplan2019";
...
%>	
    <p><h1>Girl Scouts VTK 2019-2020 Year Plan</h1></p>
	<p><h1>New</h1></p>
		<p>
