...
%>
						<li id="incomeField<%=incomeCounter%>"><input type="text" value="<%=StringEscapeUtils.escapeHtml(incomeField)%>"/></li>
...
%>
						<li id="expenseField<%=expenseCounter%>"><input type="text" value="<%=StringEscapeUtils.escapeHtml(expenseField)%>"/></li>
