...
<div class="columns large-20 large-centered">
    <p>
        Sorry! You currently don't have permission to view this tab. For questions, click Contact Us at the top of the
        page.
    </p>
</div>
...
<div class="column large-20 medium-20 large-centered medium-centered small-24">
    <form class="cmxform" id="financeAdminForm" onchange="enableSaveButton()">
        ...
        <div class="row options">
            ...
            <section class="column large-12 medium-12">
                <div id="incomeFields">
                    <span>Send To:</span><input name="recipient" id="recipient" type="text"
                                                onkeyDown="enableSaveButton()"
                                                placeholder="Enter email of the recipient" value="<%=recipient%>"/>
                </div>
            </section>
        </div>
        ...
        <div class="row">
            <section class="column large-12 medium-12">
                ...
                <ul id="income-list" class="large-block-grid-2 small-block-grid-2 text-left">
                    ...
                    %>
                    <li id="incomeField<%=incomeCounter%>"><input name="incomeValue<%=incomeCounter%>"
                                                                  onkeyDown="enableSaveButton()"
                                                                  class="financeAdminField" oninput="enableSaveButton()"
                                                                  onpaste="enableSaveButton()" maxlength="35"
                                                                  type="text"
                                                                  value="<%=StringEscapeUtils.escapeHtml(incomeField)%>"/>
                    </li>
                    <li id="incomeButton<%=incomeCounter%>"><a href="" title="remove"
                                                               onclick="return deleteIncomeRow(<%=incomeCounter%>)"><i
                            class="icon-button-circle-cross"></i></a></li>
                    <%
                            incomeCounter++;
                        }
                    %>
                </ul>
                <a class="add-btn" title="add" onclick="return addIncomeField()"><i class="icon-button-circle-plus"></i>Add
                    a Finance Field</a>
            </section>
            <section class="column large-12 medium-12">
                ...
                <ul id="expense-list" class="large-block-grid-2 small-block-grid-2 text-left">
                    ...
                    %>
                    <li id="expenseField<%=expenseCounter%>"><input onkeyDown="enableSaveButton()"
                                                                    name="expenseValue<%=expenseCounter%>"
                                                                    oninput="enableSaveButton()"
                                                                    class="financeAdminField"
                                                                    onpaste="enableSaveButton()" type="text"
                                                                    maxlength="35"
                                                                    value="<%=StringEscapeUtils.escapeHtml(expenseField)%>"/>
                    </li>
                    <li id="expenseButton<%=expenseCounter%>"><a href="" title="remove"
                                                                 onclick="return deleteExpenseRow(<%=expenseCounter%>)"><i
                            class="icon-button-circle-cross"></i></a></li>
                    <%
                            expenseCounter++;
                        }
                ...
                <a class="add-btn" title="add" onclick="return addExpenseField()"><i
                        class="icon-button-circle-plus"></i>Add a Finance Field</a>
            </section>
        </div><!--/row-->
        <!-- totals -->
        <div class="text-right row collapse">
            <a id="saveFinanceFieldFormButton" role="button" aria-label="submit form"
               onclick="return saveFinanceAdmin()" class="button save disabled">Save</a>
        </div>
