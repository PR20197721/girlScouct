<%@ page
        import="org.girlscouts.vtk.ejb.CouncilRpt, org.girlscouts.vtk.models.Contact,  org.girlscouts.vtk.models.CouncilRptBean,org.girlscouts.vtk.models.User,org.girlscouts.vtk.osgi.service.GirlScoutsSalesForceService" %>
...
<div class="column medium-23 medium-centered">
    ...
    <div class="columns medium-20 medium-centered">
        <p>
            Sorry! You currently don't have permission to view this tab. For questions, click Contact Us at the top of
            the page.
        </p>
    </div>
</div>
...
<%
    ...
    for (String ageGroup : ageGroups) {
        ...
        Map<String, String> yearPlanNames = councilRpt.getDistinctPlanByName(councilReportBeans);
        count++;
%>
<div class="row">
    <dl class="accordion" data-accordion>
        <dt data-target="panel<%=count%>"><h3 class="on"><%=ageGroup %>
        </h3></dt>
                ...
                <div class="row">
                    <div class="column medium-24">
                        <div class="row titles">
                            ...
                            <span class="name column medium-8 medium-text-center">Troop Leaders</span>
                        ...
                        <%
                            ...
                            while (itr.hasNext()) {
                                ...
                                java.util.List<CouncilRptBean> yearPlanNameBeans = councilRpt.getCollection_byYearPlanName(councilReportBeans, yearPlanName);
                        ...
                        <div class="row">
                            <dl class="accordion-inner clearfix" data-accordion="">
                                <dt data-target="panel<%=count %>_<%=y %>b" class="clearfix">
                                    <span class="name column medium-8"
                              ...
                              <a title="<%=crb.getTroopId() %>" data-reveal-id="modal_report_detail"
                                 data-reveal-ajax="true"
                                 href="/content/girlscouts-vtk/controllers/vtk.include.modals.modal_report_detail.html?cid=<%=cid%>&tid=<%=crb.getTroopId()%>"><span
                                      id="<%=crb.getTroopId()%>"><%=(crb.getTroopName() != null && !crb.getTroopName().equals("")) ? crb.getTroopName() : crb.getTroopId() %></span></span></a>
                                                </span>
