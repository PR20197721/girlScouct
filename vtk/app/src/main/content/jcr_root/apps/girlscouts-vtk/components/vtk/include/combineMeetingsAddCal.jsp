<div class="small-24 column">
            ...
            <form id="frmCalElem2">
                ...
                <section class='row clearfix'>
                    <div class="column small-6">
                        <input type="text" id="cngTime0X" value="<%= VtkUtil.formatDate(VtkUtil.FORMAT_hhmm,date) %>"
                               name="cngTime0X"/>
                    </div>
    ...
    <div class="row">
        <div class="vtk-meeting-calendar-foot column small-24 column">
            <div class="row">
                <input id="save-button-combine-calendar" class="inactive-button button tiny right" type="button"
