...
<div class="column large-20 medium-20 large-centered medium-centered small-24">
  <div class="meeting-navigation row collapse">
    <p class="column">
      <a class="direction prev" href="/content/girlscouts-vtk/en/vtk.finances.html?qtr=1"></a>
    </p>
    <div class="column">
      <h3>Q<%=qtr %> 2014</h3>
    </div>
    <p class="column">
      <a class="direction next" href="/content/girlscouts-vtk/en/vtk.finances.html?qtr=4"></a>
    </p>
  </div>
</div>
