...
var CommentBox = React.createClass({displayName: "CommentBox",
                      ...
                      React.createElement('div',{className:'__inputs'},
                        ...
                        React.createElement('div',{className:'columns small-8',onChange:function(e){_this.change(e)}},
                          React.createElement('select',{ref:'ap'},
                            React.createElement('option',{value:"pm", selected:!!~moment(time).format('LT').indexOf('PM')},"PM"),
                            React.createElement('option',{value:"am", selected:!!~moment(time).format('LT').indexOf('AM')},"AM")
                          )
                        )
	  ...
	  var MeetingImg = React.createClass({displayName: "MeetingImg",
		  render: function() {
			  ...
			  return (
				  React.createElement("img", {src: src, className: imgReturn, onClick: onClick, onError: function(){$(this).addClass('hidden');}})
			  );
		  }
	  });
...
*/
    ...
    <div style="text-align: center;"><button class="btn button btn-line" onclick="doMeetingLib(true)"><i class="icon-search-magnifying-glass"></i> SEARCH TO ADD MEETINGS</button></div>
  </div>

<div id="requirementsModal" class="reveal-modal" data-reveal=""></div><br/> <br/>
