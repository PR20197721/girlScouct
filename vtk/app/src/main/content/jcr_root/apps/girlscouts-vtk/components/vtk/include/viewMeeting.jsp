	...
	<li <%if( hasPermission(troop, Permission.PERMISSION_VIEW_MEETING_ID) ){ %>
      ...
      <div class="large-2 medium-2 small-24 columns">
				<div class="planSquare center ed-table" id="caca">
					...
					<div class="date">
						<div class="cal">
							<p class="month">Meeting</p>
							<p class="day"><%= meetingCount %></p></div>
						</div>
						<%
							} else {
						%>
						...
						<% } %>
						<div class="date">
							<div class="cal"><p class="month"><%= FORMAT_MONTH.format(date)%></p>
								<p class="day"><%= FORMAT_DAY_OF_MONTH.format(date)%></p>
