    ...
    <div class="row">
      <div class="columns large-20 medium-20">
        <ul id="sub-nav" class="inline-list hide-for-print">
          ...
          <li><a data-reveal-id="modal_upload_image" title="update photo" href="/content/girlscouts-vtk/en/vtk.include.troopPhoto.html">add/change a photo of your troop</a></li>
          <% } %>
        </ul>
      </div>
