    ...
    <div class="row">
      ...
      <div class="columns large-4 medium-4">
       <ul class="inline-list" id="util-links">
          ...
          <% if("plan".equals(activeTab)) {
        	  if (troop.getYearPlan() != null) {
        	  	Date searchDate = meetingUtil.planView(user, troop, request).getSearchDate();%>
          		<li><a class="icon" 
          		<% if(searchDate != null && searchDate.after( new java.util.Date("1/1/1977")) ){
          		%> onclick="self.location = '/content/girlscouts-vtk/en/cal.ics'"
          		<%} else{
          		%> onclick="alert('You have not yet scheduled your meeting calendar.\nPlease schedule your meetings by clicking on the MEETING DATES AND LOCATION link.')"
          		<%} %>
