...
<div class="columns large-16 medium-16 small-19 small-centered large-uncentered medium-uncentered">
  ...
  %> 
    <li><a <%= newTab.equals("true") ? "target=\"_blank\"" : "" %> <%= linkClass%> href="<%= generateLink(resourceResolver,path) %>"><%= label %></a></li>
  <% } 
  } %>
  </ul>
</div>
<div class="columns large-8 medium-8">
  ...
  <% if (socialIcons != null) { 
    ...
    %>
    <li><a <%= newTab.equals("true") ? "target=\"_blank\"" : "" %> href="<%= generateLink(resourceResolver,url) %>"><img src="<%= iconPath %>"/></a></li>
    <% } 
    } %>
  </ul>
</div>
