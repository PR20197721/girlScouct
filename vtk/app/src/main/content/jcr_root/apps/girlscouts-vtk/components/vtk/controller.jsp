...
System.err.println("manu reactActivity");					
	    	...
	    	String dates = calendarUtil.getSchedDates(user, troop, new org.joda.time.DateTime(dateFormat4.parse(request + " " + request.getParameter("calAP"))), request.getParameter("exclDt"), Long.parseLong((request.getParameter("orgDt") == null || request.getParameter("orgDt").equals("")) ? "0" : request.getParameter("orgDt")));
