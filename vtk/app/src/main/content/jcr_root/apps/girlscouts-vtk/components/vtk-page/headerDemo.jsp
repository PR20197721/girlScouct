    ...
    <div class="columns">
        <div id="header" style="width:188,height:65.8px; padding: 22px 0;" class="row">
                    ...
                    <nav class="column large-24 medium-24">
                        ...
                        <div class="vtk-demo-logo" style="width:188,height:73">
                            ...
                            <a href="/content/gssjc/en.html">
                                <img src="/content/dam/girlscouts-gsusa/images/logo/logo@2x.png" alt="Home" id="logoImg"
                                     width="188" height="73">
                            </a>
                        </div>
                    </nav>
            ...
            <div class="large-18 medium-15 hide-for-small columns topMessage">
                ...
                <a class="button tiny"
                   style="background-color:white !important; color:#009447; font-size: 12px; margin: 0 0 10px 0; padding: 5px 10px; <%=session.getAttribute("demoSiteUser")==null && session.getAttribute(org.girlscouts.vtk.models.User.class.getName()) ==null ? " display:none; " : "" %>"
                   href="/content/girlscouts-vtk/controllers/vtk.restartDemo.html?isLogout=true">Log Out</a>
                <%} %>
            ...
            <div class="vtk-control-panel hide-for-small" <%=session.getAttribute(org.girlscouts.vtk.models.User.class.getName()) == null ? " style=\"display:none !important; \" " : "" %>>
                ...
                <p>Current view: <%= isDp ? "Troop Leader" : "Parent" %>
                </p>
                ...
                <div id="vtk-dropdown-1" class="vtk-demo-dropdown" data-input-name="value1" style="">
                    ...
                    <ul class="vtk-demo-dropdown_options">
                        ...
                        <li data-value="/content/girlscouts-vtk/controllers/vtk.demo.index.html?vTroop=&user=Deb&prefGradeLevel=7-Milti-level">
                ...
                <a class="button tiny" style=""
                   href="/content/girlscouts-vtk/controllers/vtk.restartDemo.html?isLogout=true">Logout</a>

                <a class="button tiny" style="" href="/content/girlscouts-vtk/controllers/vtk.restartDemo.html">Start
                    Over</a>
            </div>
...
<div id="myModal-demo" class="reveal-modal medium" data-reveal aria-labelledby="modalTitle" aria-hidden="true"
     role="dialog">
    <h2 id="modalTitle" style="font-size:18px; color:white;padding:10px 30px;background-color:green">VTK DEMO
        DETAILS</h2>

    <div class="container-model">
        <p>The Volunteer Toolkit Demo Site mirrors all of the current features and functionality live in the VTK.
            However, this site does not necessarily mirror the exact interface a user will experience once logged in off
            of their council site; the demo emphasis is on the features and functionality of the digital tool.</p>

        <p>Please note this demo website does not contain real girl data, all troop tab data is prototypical.
            Additionally, certain features of the VTK have been disabled such as email functionality to
            “parents/caregivers” and the ability to download Year Plans and Meeting Aids, in order to protect
            proprietary information.</p>

        <p>Information presented on this website is for demo purposes only, your customizations will not be saved.
            Content presented is proprietary of Girl Scouts of the United States of America.</p>
