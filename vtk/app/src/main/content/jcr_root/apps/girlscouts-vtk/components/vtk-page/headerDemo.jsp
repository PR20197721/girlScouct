               ...
               <div class="row collapse hide-for-medium">
                  ...
                  <div class="vtk-control-panel hide-for-small" <%=session.getAttribute(org.girlscouts.vtk.models.User.class.getName()) ==null ? " style=\"display:none !important; \" " : "" %>>
                    ...
                    <% if( isDp ){%>
                        ...
                        <li data-value="/content/girlscouts-vtk/controllers/vtk.demo.index.html?vTroop=&user=Deb&prefGradeLevel=7-Multi-level">MULTI LEVEL <span>grades any</span></li>
                    ...
                    <% }else{%>
                        ...
                        <li data-value="/content/girlscouts-vtk/controllers/vtk.demo.index.html?vTroop=&user=Alex&prefGradeLevel=7-Multi-level">MULTI LEVEL <span>grades any</span></li>
