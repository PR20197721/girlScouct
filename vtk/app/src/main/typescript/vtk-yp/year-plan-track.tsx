...
import {modal, urlPath} from './data';
...
class YplanTrack extends React.Component <YplanTrackProps,
    ...
    public render(): JSX.Element {
        ...
        return (
            <div className={`_year-plan-box ${!(________app1________ !== this.props.track.split('###')[0]) ? ' __selected' : ''}`}>
                <div className="__top">
                    <p ref="one" style={(!(________app1________ !== this.props.track.split('###')[0])) ? {
                        fontWeight: 'bold',
                        fontSize: '18px',
                        lineHeight: '20px',
                        height: '46px',
                        overflow: 'hidden',
                        margin: '0px'
                    } : {height: '46px', overflow: 'hidden', margin: '0px'}}>
                        {this
                            .props
                            .track
                            .split('###')[1]
