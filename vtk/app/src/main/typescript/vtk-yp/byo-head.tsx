...
export interface BYOHeadProps {

}

declare var ________app________;

export default class BYOHead extends React.Component<BYOHeadProps, any> {

    render() {
        return (
            <div>
                <div className="columns small-24 small-centered">
                    <div className="columns large-offset-5 medium-offset-11 small-offset-9  large-2 medium-2 small-3 end" style={{textAlign: 'center'}}>
                        <span className="_triangle"></span></div>
                </div>
                <div className="__level-logo columns small-22 small-centered">
                    <div className="small-8 small-offset-5 medium-4 medium-offset-18 large-6 large-offset-18 end">
